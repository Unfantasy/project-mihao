...
function loginPhone() {
    ...
    xhr.onload = function(){
        ...
        if (data.msg == "identity_card_is_not_verified") {
            ...
            $.fn.alert2({'tip': '此交易账户已与另一众米登录账户绑定，请登录此账户进入美股交易，或者新注册聚财道交易账户',
                cancelBtnLbl: '关闭',
                confirmBtnLbl: '注册',
            ...
            $.fn.alert2({'tip': '此众米账户已经绑定另一聚财道交易账户，账户唯一绑定，请登录此交易账户',
                cancelBtnLbl: '关闭',
                confirmBtnLbl: '重新登陆'});
        } else if (data.msg == "login_user_nobind_zmuser_and_zmuser_nobind") {
            //alert(xhr.responseText);
            $.fn.alert2({'tip': '此聚财道交易账户尚未绑定众米登录账户，是否绑定此众米账户，绑定后不可以更换',
                cancelBtnLbl: '关闭',
                confirmBtnLbl: '绑定',
                confirmCallback: function(){
                    //alert(xhr.responseText);
