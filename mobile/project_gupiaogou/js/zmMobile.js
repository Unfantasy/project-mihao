...
function myCopy(e,id){
    ...
    if(isIOS){
        ...
        $('.copyDiv'+id).on('touchstart',function(e){
            ...
            timeout = setTimeout(function(){$('.copyBtn'+id).fadeIn();$('body').click(function(){$('.copyBtn'+id).hide();});},500);
            $(this).removeAttr('onclick');
        }).on('touchmove',function(e){
            moveEndX = e.originalEvent.changedTouches[0].pageX,
                moveEndY = e.originalEvent.changedTouches[0].pageY,
                scrollX = moveEndX - startX,
                scrollY = moveEndY - startY;
            ...
            moveEndX = e.originalEvent.changedTouches[0].pageX,
                ...
                scrollX = moveEndX - startX,
                scrollY = moveEndY - startY;
            if($('.copyBtn'+id).css('display')=='none'&&(scrollX==0 || scrollY==0))
                toComment(this);
            clearTimeout(timeout);
        });
    }
